    ...
    return (
        <div>
            <div className='py-4 flex items-center justify-between'>
                <h2 className="text-2xl font-bold text-white flex items-center gap-2">Trending this week in <span className='text-red-500 flex gap-1 items-center'> NYC </span></h2>
                            ...
                            <SheetHeader>
                                ...
                                <SheetDescription>
                                    ...
                                    <div className='mt-12 text-center'>
                                        <Link href={`/trendingevents/${selectedCard?.id}`}>
